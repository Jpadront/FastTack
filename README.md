...
2. **Analizar una prueba** → arriba, **dónde se perdió la prueba** frente al top 5 (salida, velocidad, maniobras, táctica);  recorrido, pasos por baliza, viento reconstruido (TWD, roladas, presión), capas del mapa (presión, TWD, amura favorecida, SOG) y línea del líder perpendicular al viento con los metros que te faltan, métricas por tramo y barco, salida (con posicionamiento: pronto/tarde, huecos, aire sucio; y viento a lo largo de la línea), polar del tramo y regularidad, maniobras por fases (giro, aceleración, ángulo de salida), táctica (amura favorecida, lado), escora óptima en ceñida y popa, laylines, puertas, barco fantasma.
...
### Tu .vkx dentro de un campeonato de RaceSense
